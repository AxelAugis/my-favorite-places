        ...
        <div className={`relative  max-w-4xl`}>
            <div className={`py-2.5 px-4 bg-[#0A3633]/30 rounded-lg shadow-lg border border-slate-600/50`}>
                <div className="w-full">
                    ...
                    <input
                        className="w-full bg-transparent placeholder:text-slate-400 text-slate-400 text-sm border border-[#E0F6EB]/40 rounded-md pl-10 pr-3 py-2 transition duration-300 ease focus:outline-none focus:border-[#E0F6EB] hover:border-[#E0F6EB]/50 shadow-sm focus:shadow"
